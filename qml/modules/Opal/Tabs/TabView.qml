...
PagedView {
  ...
  property real tabBarHeight: tabBarItem
                              && tabBarVisible ? tabBarItem.height : 0
  ...
  Loader {
    ...
    y: root.hasFooter ? root.height - tabBarLoader.height : Math.max(
                          0, -root.yOffset)
    Item {
      ...
      anchors {
        fill: parent
        topMargin: (root.yOffset > Theme.paddingSmall)
                   || root.hasFooter ? 0 : Theme.paddingSmall
      }
    }
  }
  delegate: Loader {
    ...
    property bool loading: Qt.application.active && isCurrentItem
  ...
  Component.onCompleted: {
    backgroundRectangleContainer.item = Qt.createQmlObject(
          "            import QtQuick 2.6\n            import %1 1.0\n\n            BackgroundRectangle {\n                id: backgroundRectangle\n                visible: _headerBackgroundVisible\n                anchors.fill: parent\n                color: __silica_applicationwindow_instance._backgroundColor\n            }\n        ".arg(
            "Sailfish.Silica.private"), backgroundRectangleContainer,
          "BackgroundRectangle")
  }
}
