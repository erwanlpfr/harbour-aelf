...
LiturgyRepository::LiturgyRepository(QObject* parent)
    : QObject(parent), m_service(new LiturgyService(this)) {
    connect(m_service, &LiturgyService::errorOccurred, this,
            &LiturgyRepository::onServiceErrorOccurred);

    connect(m_service, &LiturgyService::informationFetched, this,
            &LiturgyRepository::onServiceInformationFetched);

    connect(m_service, &LiturgyService::massesFetched, this,
            &LiturgyRepository::onServiceMassesFetched);

    connect(m_service, &LiturgyService::hourLiturgyFetched, this,
            &LiturgyRepository::onServiceHourLiturgyFetched);
}
...
void LiturgyRepository::onInformationFetched(const LiturgyIdentifierKey& key,
...
void LiturgyRepository::loadHourLiturgy(const LiturgyIdentifierKey& key,
...
void LiturgyRepository::onHourLiturgyFetched(const LiturgyIdentifierKey& key,
...
void LiturgyRepository::onServiceInformationFetched(const QDate& date, const QString& zone,
                                                    Information* information) {
    onInformationFetched(createKey(date, zone), information);
}

void LiturgyRepository::onServiceMassesFetched(const QDate& date, const QString& zone,
                                               QList<Mass*> masses) {
    onMassesFetched(createKey(date, zone), masses);
}

void LiturgyRepository::onServiceHourLiturgyFetched(const QDate& date, const QString& zone,
                                                    HourLiturgy::HourType type,
                                                    HourLiturgy* hourLiturgy) {
    onHourLiturgyFetched(createKey(date, zone), type, hourLiturgy);
}

void LiturgyRepository::onServiceErrorOccurred(const QDate& date, const QString& zone,
                                               const QString& error) {
