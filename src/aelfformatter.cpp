...
QString AelfFormatter::processHtml(const QString& html) {
    ...
    static QRegularExpression verseRe(R"(<span\s+class="verse_number">(\d+)</span>)",
...
QString AelfFormatter::appendReponsIfPresent(const QString& content, const QJsonObject& obj,
                                             const QString& key) {
