...
MassModel::MassModel(QObject* parent) : InformationModel(parent), m_currentMassIndex(0) {
    connect(m_liturgyRepository, &LiturgyRepository::massesChanged, this,
            &MassModel::onMassesChanged);
}
